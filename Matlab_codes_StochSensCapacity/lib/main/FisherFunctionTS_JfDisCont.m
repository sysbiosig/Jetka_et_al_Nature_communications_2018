function [FisherTS Mean_term Var_term FisherTSN Mean_termN Var_termN traj S]= FisherFunctionTS_JfDisCont(name,N,freq, init_T,y0,obs,merr, par, stim_ind,t_discont)
