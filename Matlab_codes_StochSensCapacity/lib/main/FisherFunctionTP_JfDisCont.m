...
mysolution2=ode15s(all_equations,tspan2,y0_discont,[],par); %solving Y equation
...
for i=1:npar, % for each parameter
  traj_derivative1(i)= ode15s(@der_dpark,tspan1, zeros(ext_nvar,1),[],mysolution1, par,stim_ind(i),all_equations_jacobian_dpar, all_equations_jacobian_dvar); %solving appropriate ODE
  ...
  traj_derivative2(i)= ode15s(@der_dpark,tspan2, traj_derivative_discont,[],mysolution2, par,stim_ind(i),all_equations_jacobian_dpar, all_equations_jacobian_dvar); %solving appropriate ODE
